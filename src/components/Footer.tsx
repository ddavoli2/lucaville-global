      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-10 py-16">
        <div className="flex flex-col lg:flex-row justify-between gap-12">
          ...
          <div className="max-w-sm">
            <Image
              ...
              width={240}
              height={160}
              className="h-10 w-auto object-contain brightness-125 mb-4"
              unoptimized
            />
            <p className="text-muted text-sm leading-relaxed">
              Partnering with filmmakers, creators, and independent companies
              worldwide to build ambitious projects and scale the ventures
              that support them.
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-x-16 gap-y-8">
            <div>
              <p className="text-xs uppercase tracking-[0.2em] text-gold/60 mb-4">
                Navigate
              </p>
        ...
        <div className="mt-16 pt-6 border-t border-white/[0.06] flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-muted/60 text-xs">
            &copy; {new Date().getFullYear()} Lucaville Global, Inc.
          </p>
